...
const BASE: FaceSpec = {
  ...
  lashWeight: 0.26, irisR: 0.58, irisColor: 0x5b3520, irisEdge: 0.3, pupil: 0.42,
...
const SPECS: Record<string, Partial<FaceSpec>> = {
  kai: {
    ...
    eyeTilt: 0.05, hood: 0.12, lashWeight: 0.3, irisR: 0.62, irisColor: 0x5e3a22,
  ...
  mali: {
    ...
    eyeTilt: 0.13, hood: 0.16, lashWeight: 0.32, irisR: 0.58, irisColor: 0x6b4523,
  ...
  davi: {
    ...
    eyeTilt: 0.04, hood: 0.14, lashWeight: 0.26, irisR: 0.57, irisColor: 0x3d2717,
  ...
  vera: {
    ...
    eyeTilt: 0.0, hood: 0.32, lashWeight: 0.24, irisR: 0.54, irisColor: 0x7a7a48,
    irisEdge: 0.38,
